...
# Allow importing from sibling repos without installing them as packages
...
try:
    from src.logic.parser import parse_expression, ParseError
    from src.logic.expressions import Expression
