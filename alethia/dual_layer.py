...
# Allow importing CoTShield without installing it
_REPO_ROOT = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
_COTSHIELD = os.path.join(_REPO_ROOT, "CoTShield")
if _COTSHIELD not in sys.path:
    sys.path.insert(0, _COTSHIELD)
...
class DualLayerAuditor:
    ...
    def __init__(
        ...
        if not _COTSHIELD_AVAILABLE:
            raise ImportError(
                "CoTShield not found. Ensure /home/ubuntu/CoTShield is present."
            )
